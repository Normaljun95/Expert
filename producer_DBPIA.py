                                ...
                                try :
                                   ...
                                   # rawData['author'] = item['authors']['author']
                                    if "name" in  item['publication']:
                                        rawData['journal'] = re.sub('(<([^>]+)>)', '', item['publication']['name'])  #220408 '말소리와 <!HS>음성<!HE>과학' 해결
                                    else:
                                        rawData['journal'] = re.sub('(<([^>]+)>)', '', item['publisher']['name'])    #220408 '말소리와 <!HS>음성<!HE>과학' 해결

                                    rawData['issue_inst'] = re.sub('(<([^>]+)>)', '', item['publisher']['name'])     #220408 '한국<!HS>음성<!HE>학회' 해결
