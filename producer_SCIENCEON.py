                ...
                try:
                    ...
                    for i in range(pageNumb+1):
                        ...
                        for data in resToDict['outputData']:
                            ...
                            try :
                                rawData['loop'] = cnt
                                # rawData['issue_inst'] = data['journalInfo']['publisher'].replace("&#x2219;", " ")
                                ...
                                # rawData['title'] = self.ntis_remove_html_tags(data['articleInfo']['articleTitleInfo']['articleTitle']).replace("&#x00B7;", " ")
                                rawData['title'] = self.ntis_remove_html_tags(html.unescape(data['articleInfo']['articleTitleInfo']['articleTitle']))
                                # rawData['english_title'] = self.ntis_remove_html_tags(data['articleInfo']['articleTitleInfo']['articleTitle2']).replace("&#x00B7;", " ")
